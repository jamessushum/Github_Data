...
// Find the position of the object containing id 8030403992
let index = githubData.findIndex(x => x.id ==="8030403992");
console.log(index);

// Alternative way to write the above function
let index2 = githubData.findIndex(function(x) {
  return x.id === "8030403992"
})
console.log(index2);

// Console log message on id 8030403992
let message = githubData[6].payload.commits[0].message;
console.log(message);